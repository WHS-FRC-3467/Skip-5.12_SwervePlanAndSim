...
public final class Constants {
    ...
    public static final class DRIVE {
         ...
         */
        public static final double TRACKWIDTH_METERS = 0.5334; // DONEFIXME Measure and set trackwidth
        /**
         * The front-to-back distance between the drivetrain wheels.
         *
         * Should be measured from center to center.
         */
        public static final double WHEELBASE_METERS = 0.5334; // DONEFIXME Measure and set wheelbase
        ...
        public static final int PIGEON_ID = 6; // DONEFIXME Set Pigeon ID
