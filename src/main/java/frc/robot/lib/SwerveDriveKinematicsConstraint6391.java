 ...
 */
public class SwerveDriveKinematicsConstraint6391 implements TrajectoryConstraint6391 {
   ...
   */
  public SwerveDriveKinematicsConstraint6391(
  ...
  public double getMaxVelocityMetersPerSecond(
      Pose2d poseMeters, Rotation2d rotation, double curvatureRadPerMeter, double velocityMetersPerSecond) {

    // Represents the velocity of the chassis in the x direction
    var xdVelocity = velocityMetersPerSecond * rotation.getCos();

    // Represents the velocity of the chassis in the y direction
    var ydVelocity = velocityMetersPerSecond * rotation.getSin();
