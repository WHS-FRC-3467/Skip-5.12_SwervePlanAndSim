 ...
 * trajectories.
 */
public interface TrajectoryConstraint6391 {
  /**
   * Returns the max velocity given the current pose and curvature.
   *
   * @param poseMeters The pose at the current point in the trajectory.
   * @param robotHeading The heading the robot is facing for Holonomic Drives
  ...
  double getMaxVelocityMetersPerSecond(
      Pose2d poseMeters, Rotation2d robotHeading, double curvatureRadPerMeter, double velocityMetersPerSecond);
